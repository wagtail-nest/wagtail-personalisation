...
![The form that allows you to set the rules for a segment](../images/edit_segment_rules.png)

5. **Choose the rules you want to use** – Wagtail Personalisation comes with a basic set of [default rules](../default-rules.md) that allow you to get started quickly. The rules you define will be evaluated once a visitor makes a request to your application.
