...
**Variant count** – The total amount of variants for this segment. Does not yet apply, as this will always match the amount of pages in the "Page count".
...
![The segment dashboard view](../images/segment_dashboard_view.png)
